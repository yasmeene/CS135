...
(check-within (RBG->luminosity (cons 0 (cons 255 (cons 0 empty)))) 132.75 0.01)
...
(check-expect (RGB->hex (cons 0 (cons 255 (cons 0 empty)))) (cons "0" (cons "0" (cons "F" (cons "F" (cons "0" (cons "0" empty)))))))
...
;; check-expect example for question 4c, function distance-between-points

(check-within (distance-between-points (cons 1 (cons 2 (cons 3 empty))) (cons 4 (cons 5 (cons 6 empty)))) 5.19 0.01)

;; check-expect example for question 4d, function point-in-sphere?

(check-expect (point-in-sphere? (cons 1 (cons 2 (cons 3 empty))) (cons (cons 1 (cons 2 (cons 3 empty))) (cons 4 empty))) true)

;; check-expect example for question 4e, function collide?

(check-expect (collide? (cons (cons 2 (cons 4 (cons 5 empty))) (cons 3 empty)) (cons (cons 1 (cons 4 (cons 8 empty))) (cons 5 empty))) true)
